...
public class EagleScript : MonoBehaviour
{
    ...
    [Header("Death")]
    public float tossForce = 1f;
    public float deathSpin = 1f;
    public float despawnDuration = 3f;
    ...
    void DeathAnimation()
    {
        ...
        rb.AddForce(direction * (tossForce * 100f), ForceMode2D.Impulse);
        float rotationSpeed = 90f;
        rotationSpeed *= Random.value < 0.5f ? -1f : 1f;  // 50% hægri eða vinstri snúning
        rb.angularVelocity = rotationSpeed * deathSpin;
    }
}
